...
land_coast_mask <- ifel(first_layer == 2540 | first_layer == 2530, 1, NA)  # Set land and coastline to 1, all else to NA
...
land_mask_shapefile_path <- "D:/Manuscripts_localData/FrostBound_AQ/Datasets/Land_Mask.shp"
