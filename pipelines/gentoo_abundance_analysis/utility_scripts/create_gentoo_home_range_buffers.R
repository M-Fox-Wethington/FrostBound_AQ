...
# Define the function
create_gentoo_buffers <- function(penguin_data_path, coastline_path, study_area_path, output_shapefile_path, cell_resolution = 25000, buffer_distances = c(50, 100, 150, 250, 500), dissolve_buffers = TRUE) {
