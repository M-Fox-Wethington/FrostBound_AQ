...
print(unique(consecutively_censused$site_id))
...
number_of_sites <- n_distinct(penguin_sites$site_id)
print(paste("Number of unique sites included in the study:", number_of_sites))
