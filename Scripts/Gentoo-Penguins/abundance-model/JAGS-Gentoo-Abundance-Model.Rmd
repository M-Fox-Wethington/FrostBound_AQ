...
**RUN MODELS: GLS Models on lagged year for SEA ICE CONCENTRATION**
...
**RUN MODELS: Run GLS Models on lagged year for PERSISTENCE (OPEN WATER FREQUENCY) and DURATION**
```{r}
# Load necessary libraries
library(terra)
library(sf)
...
**COMPILE BONFERRONI ADJUSTED SIGNFICANT RESULTS**
```{r}
# Load necessary libraries
library(data.table)
library(dplyr)
...
**VISUALIZE AND PLOT: SEA ICE CONCENTRATION Results for Single model**
```{r}
# Load necessary libraries
library(nlme)
library(data.table)
...
**PLOT FOREST PLOTS: Forest plots for SEA ICE CONCENTRATION AND SEA ICE EXTENT**
...
**PLOT FOREST PLOTS: PERSISENCE (OPEN WATER FREQUENCY) and DURATION**
