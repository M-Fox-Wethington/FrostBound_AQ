...
pen_value <- 0.0000001               # Value for manual or asymptotic penalty, or vector for CROPS
method_type <- "SegNeigh"        # Options: "AMOC", "PELT", "SegNeigh", "BinSeg"
max_changepoints <- 5        # Maximum number of changepoints for "BinSeg" or "SegNeigh" methods
...
analyze_sic_variability <- function(input_dataset, variable, output_directory, start_year = NULL, end_year = NULL) {
