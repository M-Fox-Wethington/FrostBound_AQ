...
**CALCULATE Sea Ice Mean Monthly PERSISTENCE (OPEN WATER FREQUENCY) and DURATION and SEA ICE CONCENTRATION**
...
**Southern Oscillation Index Analysis with sea ice trends**

```{r Southern Oscillation Index Analysis with Sea Ice Trends}
# Load necessary libraries
library(dplyr)
library(lubridate)
library(ggplot2)
...
**Duration and Open Water Freqeucy  + Trend analysis - Basic glm**
   ...
   Processing of Sea Ice Data
    ...
    Metric Calculation for Each Year:
        For each year in the range start_year to end_year, the script calculates the specified metrics (Open Water Freqeucy , duration, concentration) for each cell in the raster stack.

    Open Water Freqeucy Calculation:
        Open Water Freqeucy: The number of days per year where sea ice concentration is above a threshold (0.15).
        This is calculated using a sum function over the raster stack for the year.
