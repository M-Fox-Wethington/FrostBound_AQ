...
# Load Raster Stack
r <- rast("D:/Manuscripts_localData/FrostBound_AQ/Datasets/AMSRE-Unified_Winter_Processed/stack/AMSR-E-Unified_Winter_SIC_Stack_Cropped.tif")

# loaded_raster_stack <- rast(r)
