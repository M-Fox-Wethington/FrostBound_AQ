...
start_time <- Sys.time()
ann_model <- nnet(nsidc ~ amsr, data = train_data, size = 7, linout = TRUE, decay = 0.001, maxit = 500, trace = TRUE)
end_time <- Sys.time()
...
# saveRDS(ann_model, file = "D:/Manuscripts_localData/FrostBound_AQ/Datasets/dataset-harmonization/normalized_rasters_2012-2023/final_ann_model.rds")
