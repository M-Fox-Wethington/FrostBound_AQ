...
**Deploy ANN across entire NSIDC Dataset**
...
# Harmonize the entire NSIDC stack (assuming this is what you want)
harmonized_stack <- app(nsidc_resampled_to_12_5km, predict_harmonized_values)

plot(harmonized_stack[[2500]])
